...
describe SendGrid4r::REST::Webhooks::ParseApi do
    ...
    context 'without block call' do
      it '#get_parse_settings' do
        ...
        begin
          ...
          expect(parse_settings).to be_a(SendGrid4r::REST::Webhooks::ParseApi::ParseSettings)
  ...
  describe 'unit test', :ut do
    ...
    it '#get_parse_settings' do
      ...
      expect(actual).to be_a(SendGrid4r::REST::Webhooks::ParseApi::ParseSettings)
    end

    it 'creates parse_settings instance' do
      actual = SendGrid4r::REST::Webhooks::ParseApi.create_parse_settings(parse_settings)
      expect(actual).to be_a(SendGrid4r::REST::Webhooks::ParseApi::ParseSettings)
